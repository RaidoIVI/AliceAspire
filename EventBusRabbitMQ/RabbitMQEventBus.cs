...
public class RabbitMqEventBus(
    ...
    IModel consumerChannel) : IEventBus, IDisposable, IHostedService
{
    private const string ExchangeName = "alice_event_bus";
    ...
    private IConnection _rabbitMqConnection = rabbitMqConnection;

    private IModel _consumerChannel = consumerChannel;
