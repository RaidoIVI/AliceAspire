...
namespace InstagramApiSharp.API
{
    ...
    internal class InstaApi : IInstaApi
    {
        ...
        public async Task<IResult<InstaChallengeRequireSMSVerify>> RequestVerifyCodeToSMSForChallengeRequireAsync(bool replayChallenge, string choise = "0")
        {
            return await RequestVerifyCodeToSMSForChallengeRequire(replayChallenge, choise: choise);
        }
        /// <summary>
        ...
        private async Task<IResult<InstaChallengeRequireSMSVerify>> RequestVerifyCodeToSMSForChallengeRequire(bool replayChallenge, string phoneNumber = null, string choise = "0")
        {
            if (_challengeinfo == null)
        ...
        public async Task<IResult<InstaLoginResult>> VerifyCodeForChallengeRequireAsync(string verifyCode, string choise = "0")
        {
            if (_challengeinfo == null)
