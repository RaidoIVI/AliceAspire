...
namespace InstagramApiSharp.API
{
    ...
    public interface IInstaApi
    {
        ...
        Task<IResult<InstaChallengeRequireSMSVerify>> RequestVerifyCodeToSMSForChallengeRequireAsync(bool replayChallenge = false, string choise = "0");
        /// <summary>
        ...
        Task<IResult<InstaLoginResult>> VerifyCodeForChallengeRequireAsync(string verifyCode, string choise = "0");
